...
/// A handler is a class that is consulted by Opener when the system is about to open a URL. If a
/// handler returns an NSURL from openURL:sender:, this URL will be used instead. If the handler
/// doesn’t want to replace the URL, it returns nil.
///
...
///
/// If nil, a switch will be shown in Settings, and enabled/disabled state is handled by Opener.
/// Otherwise, tapping the cell will push your list controller, and enabled state is handled by your
/// code.
///
...
/// @param sender The bundle identifier of the app that invoked the URL open request. If the request
/// was invoked through SpringBoard or a non-graphical program such as `uiopen`, this argument is
/// nil.
